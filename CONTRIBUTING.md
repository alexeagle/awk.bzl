...
some other ruleset that depends on awk.bzl, or in a nested
...
```sh
OVERRIDE="--override_repository=awk.bzl=$(pwd)/awk.bzl"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@awk.bzl` on your system will point to this folder.
...
https://github.com/alexeagle/awk.bzl/actions/workflows/tag.yaml
